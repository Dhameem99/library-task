...
function Add_Book() {
    ...
    onSubmit: async (values) => {
      try {
        let bookAdd = await axios.post(
          "https://638875daa4bb27a7f78705d4.mockapi.io/api/books",
          values
        );
  ...
  return (
    <div class="container-fluid px-4">
      ...
      <form
        class="row g-3 m-4 border border-3 border-success rounded"
      ...
      >
        <div class="col-md-6">
          ...
          <input
            ...
            type="text"
            class={`form-control ${formik.errors.title ? "error-box" : ""} ${
        ...
        <div class="col-md-6">
          ...
          <input
            ...
            type="text"
            class={`form-control ${formik.touched.author && formik.errors.author ? "error-box" : ""} ${
        ...
        <div class="col-md-6">
          ...
          <input
            ...
            type="text"
            class={`form-control ${formik.touched.isbn && formik.errors.isbn ? "error-box" : ""} ${
        ...
        <div class="col-md-6">
          ...
          <input
            ...
            class={`form-control ${formik.touched.publisher && formik.errors.publisher ? "error-box" : ""} ${
        ...
        <div class="col-md-4">
          ...
          <input
            ...
            class={`form-control ${formik.touched.year && formik.errors.year ? "error-box" : ""} ${
